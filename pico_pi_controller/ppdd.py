...
__all__ = ['logger', 'log_txn', 'PwrLedFlicker', 'i2c_event_handler', 'main', 'empty', 'pause', 'hostname', 'cmd_code',
           'REG_NAME', 'REG_INT']
...
def i2c_event_handler(id, tick):
    ...
    def reg_bos():
        fname='reg_bos'
        log_txn(fname, "sending bosmang status: ", bosmang.decode())
...
def main():
    ...
    parser.add_argument("-a", default=0x13, type=int, help="Default I2C address: 0x13")
    parser.add_argument("-b", action="store_false",   help="Set bosmang status to True")
    ...
    log_txn(fname,"bosmang: ", bool(bosmang.decode()))
